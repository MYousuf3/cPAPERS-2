...
BASE_COMMAND="python figure_zs.py --split test --temperature"

# Define the temperatures to iterate over
TEMPERATURES=(0.1 0.3 0.5 0.7 0.9)

# Define the options for --modality
MODALITY_OPTIONS=('caption' 'context' 'reference')

# Define the seeds
SEEDS=(5731 6824 6986 4271 3533)

# Define the log file
LOG_FILE="output_zs_figure_temperature_llama70b_test_5seeds_None.log"
...
#             COMMAND="$BASE_COMMAND $temp --modality $modality_option --seed ${SEEDS[$i]}"
...
python figure_zs.py --split test > "$LOG_FILE" 2>&1
