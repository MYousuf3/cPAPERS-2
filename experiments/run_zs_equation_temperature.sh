...
BASE_COMMAND="python equation_zs.py --split test --temperature"

# Define the temperatures to iterate over
TEMPERATURES=(0.1 0.3 0.5 0.7 0.9)

# Define the options for --modality
MODALITY_OPTIONS=('equation' 'context' 'reference')

# Define the seeds
SEEDS=(5731 6824 6986 4271 3533)

# Define the log file
LOG_FILE="output_zs_equation_temperature_llama70b_5seeds_None.log"
...
python equation_zs.py --split test > "$LOG_FILE" 2>&1
